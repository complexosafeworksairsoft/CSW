...
export const metadata: Metadata = {
  title: "Entrar | Safe Works",
  description: "Acesse sua conta pessoal no Complexo Safe Works.",
};

export default async function ContaLoginPage() {
    ...
    <section className="relative overflow-hidden bg-olive-deep text-[#F0EBDB]">
      ...
      <div className="relative mx-auto max-w-md px-4 py-20 sm:px-6 sm:py-28">
        ...
        <p className="mt-3 text-white">
          Acesse sua conta pessoal para solicitar entrada em uma equipe e
