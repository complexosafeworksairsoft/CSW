...
const ETAPAS = [
  {
    ...
    desc: "Cadastro do jogador, verificação do equipamento e validação de responsabilidade.",
  },
  {
    n: "02",
    title: "Briefing de segurança",
    desc: "Antes de qualquer partida, arbitragem e jogadores revisam as regras, os limites do terreno, modo de jogo e principalmente o FPS do equipamento.",
  },
  {
    n: "03",
  ...
  },
  {
    ...
    desc: "Rodadas conduzidas com arbitragem presente, sinalização de vitória e paradas de segurança quando necessário.",
  },
  {
    n: "05",
    title: "Debriefing e encerramento",
    desc: "Conversa pós-jogo sobre o que funcionou, devolução de equipamentos alugados e liberação da área.",
  },
];
...
const PRINCIPIOS = [
  ...
  },
  {
    ...
    desc: "Existe uma distância mínima para engajar um alvo em segurança, que muda conforme a potência da réplica.",
  },
  {
    title: "Limite de potência (FPS)",
    desc: "Toda réplica é testada no cronógrafo antes de entrar em campo. O limite de potência praticado no Complexo é 330 fps com bolinha de 0,20g, ou 1 joule. Equipamentos acima dessa potência são proibidos.",
  },
  {
    title: "Arbitragem ativa",
    desc: "Árbitros acompanham a partida, com autoridade para parar o jogo, aplicar penalidades ou remover um jogador em caso de conduta insegura.",
  },
];
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <p className="mt-3 max-w-2xl text-ink-soft">
          A tabela de valores e aluguel de equipamento (para quem ainda não tem
          réplica própria) está em definição. Fale com a gente para confirmar
          disponibilidade de agenda e valores promocionais.
        </p>
        <div className="mt-8 grid gap-px bg-line border border-line sm:grid-cols-3">
          {[
            { title: "Turno de jogo", desc: "Acesso a uma sessão de partidas no período agendado. O turno dura 3h, sendo 1h para organização e briefing." },
